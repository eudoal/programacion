  ...
  public function actualizarUsuario()
{
  ...
  if (isset($_POST["actualizar"])) {
     if ($this->conector->connect_errno) {
        ...
        $actualiza = "UPDATE usuarios SET nombre= '$_POST[nombre]', apellidos= '$_POST[apellidos]', edad= '$_POST[edad]', curso= '$_POST[curso]' WHERE correo = '$_POST[correo]'";
  ...
  public function borrar()
{
  ...
  {
      $resultado1 = $this->conector->query("SELECT * FROM usuarios WHERE correo='$_GET[correo]'");
      return $resultado1;
  }
